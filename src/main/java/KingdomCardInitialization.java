...
public final class KingdomCardInitialization {
    ...
    private static Card buildArtisan() {
    ...
    private static Card buildBandit() {
    ...
    private static Card buildBureaucrat() {
    ...
    private static Card buildGardens() {
    ...
    private static Card buildHarbinger() {
    ...
    private static Card buildLibrary() {
    ...
    private static Card buildMerchant() {
    ...
    private static Card buildMilitia() {
    ...
    private static Card buildMoneylender() {
    ...
    private static Card buildPoacher() {
    ...
    private static Card buildRemodel() {
    ...
    private static Card buildSentry() {
    ...
    private static Card buildThroneRoom() {
    ...
    private static Card buildVassal() {
    ...
    private static Card buildWitch() {
    ...
    private static Card buildWorkshop() {
